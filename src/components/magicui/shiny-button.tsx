...
import type { MotionProps } from "motion/react"; // apenas tipo
...
>(({ children, className, ...props }, ref) => {
  return (
    ...
    >
      <span
        className="relative block size-full text-white font-normal text-sm tracking-wide text-[rgb(0,0,0,65%)] dark:font-light dark:text-[rgb(255,255,255,90%)]"
        style={{
          maskImage:
